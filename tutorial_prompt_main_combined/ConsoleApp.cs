                        ...
                        if (body.IsTracked)
                        {
                            ...
                            if (connected && !dataBeingPrepped)
                            {
                                ...
                                else if (leftLegIn() && (started || tutorialStarted))
                                {
                                	...
                                	{
                                		if((int)theHokeyPokeyDance.CurrentState == (int)DanceState.LEFT_LEG_SHAKE_15 && !leftLegFreebie && !inTutorial)
                                		{
                                ...
                                else if (rightLegIn() && (started || tutorialStarted))
                                {
                                	...
                                	{
                                		if((int)theHokeyPokeyDance.CurrentState == (int)DanceState.RIGHT_LEG_SHAKE_20 && !rightLegFreebie && !inTutorial)
                                		{
                                ...
                                else if(leftArmIn() && (started || tutorialStarted))
                                {
                                	if(previousPosition.Equals("leftArmIn") || previousPosition.Equals("leftArmShake"))
                                	{
                                		if(leftArmShaking(leftHandLastX))
                                		{
                                			...
                                			else //in tutorial program or when the robot is supposed to do the correct thing in the actual LfD program
                                			{
                                				...
                                				{
                                					if((int)theHokeyPokeyDance.CurrentState == (int)DanceState.LEFT_HAND_IN_4)
                                					{
                                						Console.WriteLine("Participant correctly did left hand shake");
                                						file.WriteLine("Participant correctly did left hand shake. Time: " + getTimeStamp(DateTime.Now));
                                					...
                                					{
                                						Console.WriteLine("Participant incorrectly performed left hand shake");
                                						file.WriteLine("Participant incorrectly performed left hand shake. Time: " + getTimeStamp(DateTime.Now));
                                	...
                                	{
                                		if((int)theHokeyPokeyDance.CurrentState == (int)DanceState.LEFT_HAND_SHAKE_5 && !leftArmFreebie && !inTutorial)
                                		{
                                		...
                                		else //in tutorial program or when the robot is supposed to do the correct thing in the actual LfD program
                                		{
                                			...
                                			else //in tutorial
                                			{
                                				...
                                				{
                                					Console.WriteLine("Participant correctly put their left hand in");
                                					file.WriteLine("Participant correctly put their left hand in. Time: " + getTimeStamp(DateTime.Now));
                                				...
                                				{
                                					Console.WriteLine("Participant incorrectly put their left hand in");
                                					file.WriteLine("Participant incorrectly put their left hand in. Time: " + getTimeStamp(DateTime.Now));
                                					...
                                					//dataToSend = "leftArmInIncorrect " + theHokeyPokeyDance.CurrentState + " yes";
                                					dataToSend = "incorrect " + theHokeyPokeyDance.CurrentState + " yes";
                                				}
                                			}
                                		}
                                ...
                                else if (rightArmIn() && (started || tutorialStarted))
                                {
                                	if(previousPosition.Equals("rightArmIn") || previousPosition.Equals("rightArmShake"))
                                	{
                                		if(rightArmShaking(rightHandLastX))
                                		{
                                			...
                                			else //in tutorial program or when the robot is supposed to do the correct thing in the actual LfD program
                                			{
                                                ...
                                                {
                                                    if((int)theHokeyPokeyDance.CurrentState == (int)DanceState.RIGHT_HAND_IN_9)
                                                    {
                                                        Console.WriteLine("Participant correctly did right hand shake");
                                                        file.WriteLine("Participant correctly did right hand shake. Time: " + getTimeStamp(DateTime.Now));
                                                    ...
                                                    {
                                                        Console.WriteLine("Participant incorrectly performed right hand shake");
                                                        file.WriteLine("Participant incorrectly performed right hand shake. Time: " + getTimeStamp(DateTime.Now));
                                	...
                                	{
                                		if((int)theHokeyPokeyDance.CurrentState == (int)DanceState.RIGHT_HAND_SHAKE_10 && !rightArmFreebie && !inTutorial)
                                		{
                                		...
                                		else //in tutorial program or when the robot is supposed to do the correct thing in the actual LfD program
                                		{
                                            ...
                                            else //in tutorial
                                            {
                                                ...
                                                {
                                                    Console.WriteLine("Participant correctly put their right hand in");
                                                    file.WriteLine("Participant correctly put their right hand in. Time: " + getTimeStamp(DateTime.Now));
                                                ...
                                                {
                                                    Console.WriteLine("Participant incorrectly put their right hand in");
                                                    file.WriteLine("Participant incorrectly put their right hand in. Time: " + getTimeStamp(DateTime.Now));
